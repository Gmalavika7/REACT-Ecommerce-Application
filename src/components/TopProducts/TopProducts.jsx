...
const ProductsData = [
    {
        ...
        title: "Casual  Wear",
        description: 
            "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero sed commodi laboriosam?"
...
<div>
  <div className='container'>
    ...
    <div className='text-left mb-24 '>
            <p data-aos="fade-up" className='textPrimary textSm' >Top Rated Products for you</p>
            <h1 data-aos="fade-up" className='text-3xl font-bold'>Best Products</h1>
            <p data-aos="fade-up" className='text-xs text-gray-400'>
              Lorem ipsum dolor sit amet consectetur 
              adipisicing elit. Sit 
              asperiors modi Sit asperiors modi
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2
            ...
            '>
        {
            ProductsData.map((data) => (
                ...
                hover:bg-black/80 dark:hover:bg-textPrimary 
                ...
                duration-high group max-w-[300px]'>
                    ...
                    <div className='p-4 text-center'>
                        ...
                        text-sm line-clamp-2'>
                            ...
                            <button 
                            className='bg-[var(--primary)] hover:scale-105
